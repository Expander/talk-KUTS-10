...
\begin{frame}[noframenumbering]{Determination of $g_3(M_Z)$}
  ...
  \end{align*}
  \\\vspace{2em}
  SM: \mycite{9305305, 9707474, 9708255, 0004189}\\
  split-MSSM: \mycite{9305305, 9707474, 9708255, 0004189}\\
  MSSM: \mycite{0509048, 0810.5101, 1009.5455}
\end{frame}
...
\begin{frame}[noframenumbering]{Determination of $y_t(M_Z)$}
  ...
  \end{align*}
  SM: \mycite{9912391, 1205.2892} \\
  split-MSSM: \mycite{1312.5220}\\
  MSSM: \mycite{0210258, 0507139}
\end{frame}
...
\begin{frame}[noframenumbering]{Determination of $M_h^2$ in the SM and split-MSSM}
  ...
  \end{align*}
  SM: \mycite{1205.6497, 1504.05200, 1407.4336}\\
  split-MSSM: \mycite{1205.6497, 1312.5220}
\end{frame}
...
\begin{frame}[noframenumbering]{Determination of $M_h^2$ in the MSSM}
  ...
  \begin{align*}
    M_h^2 &= \Eigenvalue\Big[
            ...
            \Big]
  \end{align*}
  MSSM: \mycite{0105096, 0112177, 0212132, 0206101, 0305127, 1708.05720}
\end{frame}
