...
\begin{frame}[noframenumbering]{$M_h$ at 1-loop and scale variation}
  \begin{align*}
    M_{h}^2 = \frac{1}{4} (g_Y^2 + g_2^2) v^2 \cos^2 2 \beta + 
    \frac{6 y_t^4 v^2}{(4\pi)^2} \left[ \ln \frac{\MS^2}{m_t^2} +
      \frac{X_t^2}{\MS^2} - \frac{X_t^4}{12 \MS^4}\right]
  \end{align*}
  \begin{align*}
    (4\pi)^2 \beta_{y_t} &=
                           -\frac{13}{15} g_1^2 y_t - 3 g_2^2 y_t - \frac{16}{3} g_3^2 y_t + 6 y_t^3 \approx -2 \\
                         &= y_t \left( 6 y_t^2 - 5.33 g_3^2\right) \approx 0 \quad\text{for}\quad g_1 = g_2 = 0
  \end{align*}
\end{frame}

\begin{frame}[noframenumbering]{$M_h$ scale variation}
  \begin{center}
    \includegraphics[width=\textwidth,bb=0 0 440 300,clip]{{{plots/kuts-9/scan_Q}}}
  \end{center}
  square: 1L, triangle: 2L, circle: 3L
\end{frame}
